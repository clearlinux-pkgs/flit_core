...
Source0  : https://files.pythonhosted.org/packages/2c/a9/64406cf5c1c31186e1208a290ff10a0add43882edaef5eeba49e15ba6e7f/flit_core-3.4.0.tar.gz
...
%prep
%setup -q -n flit_core-3.4.0
cd %{_builddir}/flit_core-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636525612
